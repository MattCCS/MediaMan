...
class OneDriveConfig(models.BaseConfig):
...
class OneDriveReceiptFile(models.AbstractReceiptFile):
...
class OneDriveDownloadReceiptFile(models.AbstractDownloadReceiptFile, OneDriveReceiptFile):
...
class OneDriveResultFile(models.AbstractResultFile):
...
class OneDriveResultFileList(models.AbstractResultFileList):

    def __init__(self, file_list_data):
        self.items = {d["id"]: OneDriveResultFile(d) for d in file_list_data["items"]}
...
class OneDriveResultQuota(models.AbstractResultQuota):
